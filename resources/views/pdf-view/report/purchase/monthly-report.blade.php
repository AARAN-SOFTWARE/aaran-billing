    ...
    <table class="w-full border-b border-gray-300">
        ...
        @foreach($list as $index=>$row)
            ...
            <tr class="text-[10px] border-b border-r border-gray-300 self-start ">
                ...
                <td class="py-2 text-center px-0.5 border-r border-gray-300">{{$row->Entry_no}}</td>
                <td class="py-2 text-center px-0.5 border-r border-gray-300"> {{ date('d-m-Y', strtotime( $row->purchase_date))}}</td>
                ...
                <td class="py-2 text-center px-0.5 border-r border-gray-300">{{$row->sales_type=='1'?\App\Http\Controllers\Report\Purchase\MonthlyReportController::getPercent($row->id,$row->sales_type):0}}</td>
