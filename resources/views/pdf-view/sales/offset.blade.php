...
<div class="p-5">
    ...
    <div class="border-r border-l border-gray-300 flex items-center">
        ...
        <div class="w-1/3 flex-col flex justify-between  text-xs h-[195px]">
            ...
            ">{{number_format($obj->total_gst/2,2,'.','')}}</span>
                @else
                    <span class="w-1/3">IGST&nbsp;@&nbsp;{{$gstPercent*2}}% </span><span
                        class="w-1/3 text-center">:</span><span class="pr-3 w-1/3 text-end
            ...
            <div class="flex items-center justify-between border-b border-gray-300 p-1">
                @if($obj->additional!=0)
                    <span class="w-1/3 inline-flex items-center">Add - <span text-[10px]>{{ $obj->ledger_name }}</span></span>
                @else
...
<div class="border-r border-l border-gray-300 flex items-center">
    <div class="w-2/3 border-r border-b border-gray-300 h-[195px]">
        ...
        <div class="font-semibold text-[10px] text-gray-600 px-1">* Goods once sold cannot be return back or exchanged
        </div>
        <div class="font-semibold text-[10px] text-gray-600 px-1">* Seller cannot be responsible for any
            damage/mistakes.
        </div>
    ...
    <div class="w-1/3 flex-col flex justify-between  text-xs h-[195px]">
        ...
        <div class="flex items-center justify-between border-b border-gray-300 p-1">
            ...
            ">{{number_format($obj->total_gst/2,2,'.','')}}</span>
            @else
                <span class="w-1/3">IGST&nbsp;@&nbsp;{{$gstPercent*2}}% </span><span class="w-1/3 text-center">:</span>
                <span class="pr-3 w-1/3 text-end
            ">{{number_format($obj->total_gst,2,'.','')}}</span>
            @endif
        </div>
