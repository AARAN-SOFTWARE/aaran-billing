    ...
    <div class="flex-col flex gap-10 tracking-wider p-2">
        ...
        <div class=" bg-[#F8F8FF] gap-10 flex sm:flex-row flex-col tracking-wider rounded-lg ">
            ...
            <div class="sm:w-5/12 w-auto bg-white  rounded-lg flex-col flex h-[28rem] gap-y-5 hover:shadow-md gap-y">
                ...
                <div class="flex-col flex px-5 h-[24] overflow-y-auto gap-y-5" wire:poll.300s>
                    @forelse($blogs as $index=>$row)
                    <a href="{{route('showArticles',[$index])}}">
                        <div class="w-full h-auto  flex gap-x-2 bg-gray-50 hover:bg-slate-100 rounded-md animate__animated
                            wow animate__backInRight" data-wow-duration="3s">
                            <div class="h-24 w-32">
                                <img src="{{$row['image']}}" class="w-full h-20" alt="">
                            </div>
                            <div class="w-4/6 flex-col flex py-1 ">
                                <div class="h-1/4 inline-flex items-center gap-x-2">
                                    ...
                                    <span class="text-xs text-gray-600">By {{$row['user_name']}}</span>
                                </div>
                    ...
                    @empty
                    @for($i=0; $i<=8; $i++) <div class="w-full h-auto  flex gap-x-2 bg-gray-50 hover:bg-slate-100 rounded-md animate__animated wow animate__backInRight" data-wow-duration="3s">
                        <div class="h-24 w-32">
                            <img src="../../../../images/home/bg_1.webp" class="w-full h-full rounded-l-md" alt="">
                        </div>
                        <div class="w-4/6 flex-col flex py-1 ">
                            <div class="h-1/4 inline-flex items-center gap-x-2">
                                <span>
