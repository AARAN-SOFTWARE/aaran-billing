    ...
    <div class="w-7/12 mx-auto mt-20">
        ...
        <div class="space-y-3 py-10">
            ...
            <div class=" text-gray-600 text-sm ">
                <span class="uppercase text-red-600 pl-10 pr-2"> {{ $blog['user_name'] }}
                </span>
        ...
        <div class="py-10 space-y-5">
            ...
            <div class="w-full flex gap-5 ">
                @for($i = 0; $i < 3; $i++)
                    <div class="w-1/3 overflow-hidden rounded-md relative group cursor-pointer">
                        ...
                        <div
                            class="absolute bottom-0 translate-y-20 group-hover:translate-y-0 transition-all duration-300 ease-in-out p-3 text-xs text-white bg-black/40">
        ...
        <div class=" flex justify-between items-center gap-x-5 font-lex text-blue-800 py-10">
            <div
                class="border px-4 py-2 text-xs flex items-center justify-center gap-x-5 rounded-sm cursor cursor-pointer">
