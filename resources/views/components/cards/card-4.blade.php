...
@foreach($list as $index=>$row)
    ...
    <!-- card 1 -->
        <div class="relative flex flex-col bg-white shadow-sm border  border-blue-400 rounded-lg w-[25rem] p-2">
            <div class="p-3">
        ...
        <!-- card 2 -->
        <div class="relative flex flex-col bg-white shadow-sm border border-green-400 rounded-lg w-[25rem] p-2">
            <div class="p-3">
                <div class="flex items-center mb-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                         stroke="currentColor" class="h-5 w-5 text-slate-600">
