<div class="relative">
    ...
    <div
        class="grid lg:grid-cols-2 h-[35rem] font-roboto tracking-wider bg-[#F2F3F4] mt-12 py-3 sm:h-[40rem] sm:grid-cols-1">
        ...
        <div class="md:block hidden">
            <img src="../../../../images/laptop.png" alt=""
                 class="z-20 absolute right-16 -top-14  w-[50rem] h-auto animate__animated wow animate__backInLeft transform "
