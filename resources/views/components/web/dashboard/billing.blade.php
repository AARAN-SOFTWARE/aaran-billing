    ...
    <div class="flex-col flex h-full">
        <div class="flex items-center justify-between p-3 border-b border-gray-200">
            <div class=" w-3/12 flex-col flex gap-y-2 justify-center items-center">
                ...
                <div class="text-center font-semibold text-[#23B7E5] text-xs">Sales</div>
            </div>
            <div class="w-3/12 text-center">
                <span class="text-xs font-semibold ">INV A1-005</span>
                <div class="text-xs text-gray-600">{{ date('d-M-y') }}</div>
            </div>
            <span class="w-3/12 text-sm font-semibold text-green-600 text-center">₹ 43000</span>
            <span
                class="w-3/12 text-xs text-center"><span
        ...
        <div class="flex items-center justify-between p-3 border-b border-gray-200">
            <div class=" w-3/12 flex-col flex gap-y-2 justify-center items-center">
                ...
                <div class="text-center font-semibold text-[#845ADF] text-xs">Purchase</div>
            </div>
            <div class="w-3/12 text-center">
                <span class="text-xs font-semibold ">INV A1-005</span>
                <div class="text-xs text-gray-600">{{ date('d-M-y') }}</div>
            </div>
            <span class="w-3/12 text-sm font-semibold text-green-600 text-center">₹ 21000</span>
            <span
                class="w-3/12 text-xs text-center"><span
        ...
        <div class="flex items-center justify-between p-3 border-b border-gray-200">
            <div class=" w-3/12 flex-col flex gap-y-2 justify-center items-center">
                ...
                <div class="text-center font-semibold text-[#E6533C] text-xs">Payment</div>
            </div>
            <div class="w-3/12 text-center">
                <span class="text-xs font-semibold ">INV A1-005</span>
                <div class="text-xs text-gray-600">{{ date('d-M-y') }}</div>
            </div>
            <span class="w-3/12 text-sm font-semibold text-green-600 text-center">₹ 15500</span>
            <span
                class="w-3/12 text-xs text-center"><span
