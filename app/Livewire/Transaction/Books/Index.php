...
//            $this->account_type_name = $AccountBook->accountType->vname;
    ...
    {
        return Transaction::select('transactions.id', 'transactions.vname', 'transactions.vdate', 'transactions.account_book_id', 'transactions.mode_id')
    ...
    public function render()
    {
        ...
        return view('livewire.transaction.books.index')->with([
